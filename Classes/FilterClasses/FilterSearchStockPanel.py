...
#region Public Methods
    ...
    def set_all_to_false(self):
        self.set_max_price_mover(False)
        self.set_min_price_mover(False)
        self.set_max_volume_mover(False)
        self.set_min_volume_mover(False)
        self.set_mover_above_zero(False)
        self.set_mover_above_fifty(False)
        self.set_mover_above_hundred(False)
        self.set_mover_below_zero(False)
        self.set_mover_below_fifty(False)
        self.set_mover_above_zero_to_ten(False)
        self.set_mover_above_ten_to_twenty(False)
        self.set_mover_above_twenty_to_thirty(False)
        self.set_mover_above_thirty_to_fourty(False)
        self.set_mover_below_zero_to_ten(False)
        self.set_mover_below_ten_to_twenty(False)
        self.set_mover_below_twenty_to_thirty(False)
        self.set_mover_below_thirty_to_fourty(False)
        self.set_trailing_price_earnings_max(False)
        self.set_forward_price_earnings_max(False)
        self.set_price_to_book_max(False)
        self.set_book_value_share_max(False)
        self.set_eps_current_year_max(False)
        self.set_eps_trailing_twelve_months_max(False)
        self.set_eps_forward_max(False)
        self.set_mover_fifty_weeks_above_zero(False)
        self.set_mover_fifty_weeks_above_fifty(False)
        self.set_mover_fifty_weeks_above_hundred(False)
        self.set_mover_fifty_weeks_below_zero(False)
        self.set_mover_fifty_weeks_below_fifty(False)
        self.set_mover_fifty_weeks_above_zero_to_ten(False)
        self.set_mover_fifty_weeks_above_ten_to_twenty(False)
        self.set_mover_fifty_weeks_above_twenty_to_thirty(False)
        self.set_mover_fifty_weeks_above_thirty_to_fourty(False)  
        self.set_mover_fifty_weeks_below_zero_to_ten(False)     
        self.set_mover_fifty_weeks_below_ten_to_twenty(False)
        self.set_mover_fifty_weeks_below_twenty_to_thirty(False)
        self.set_mover_fifty_weeks_below_thirty_to_fourty(False)
        self.set_dividend_only(False)
        self.set_no_dividend_only(False)
#enderegion
