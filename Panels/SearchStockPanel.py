...
#region - Event Handler Methods
    ...
    def __on_check_max_mover(self, evt):
        self.__mFilterSearchStockPanel.set_all_to_false()
        self.__clear_checks(self.__mcbMaxPriceMover)

    def __on_check_min_mover(self, evt):
        self.__mFilterSearchStockPanel.set_all_to_false()
        self.__clear_checks(self.__mcbMinPriceMover)

    def __on_check_max_volume(self, evt):
        self.__mFilterSearchStockPanel.set_all_to_false()
        self.__clear_checks(self.__mcbMaxVolumeMover)

    def __on_check_min_volume(self, evt):
        self.__mFilterSearchStockPanel.set_all_to_false()
        self.__clear_checks(self.__mcbMinVolumeMover)
    ...
    def __on_check_trailing_price_earnings_max(self, evt):
        self.__mFilterSearchStockPanel.set_all_to_false()
        self.__clear_checks(self.__mcbTrailingPriceEarningsMax)

    def __on_check_forward_price_earnings_max(self, evt):
        self.__mFilterSearchStockPanel.set_all_to_false()
        self.__clear_checks(self.__mcbForwardPriceEarningsMax)

    def __on_check_price_book_max(self, evt):
        self.__mFilterSearchStockPanel.set_all_to_false()
        self.__clear_checks(self.__mcbPriceToBookMax)

    def __on_check_book_value_share_max(self, evt):
        self.__mFilterSearchStockPanel.set_all_to_false()
        self.__clear_checks(self.__mcbBookValuePerShareMax)

    def __on_check_eps_current_year_max(self, evt):
        self.__mFilterSearchStockPanel.set_all_to_false()
        self.__clear_checks(self.__mcbEPSCurrentYearMax)

    def __on_check_eps_trailing_twelve_months_max(self, evt):
        self.__mFilterSearchStockPanel.set_all_to_false()
        self.__clear_checks(self.__mcbEPSTrailingTwelveMonthsMax)

    def __on_check_eps_forward_max(self, evt):
        self.__mFilterSearchStockPanel.set_all_to_false()
        self.__clear_checks(self.__mcbEPSForwardMax)
    ...
    def __on_check_dividend_only(self, evt):   
        ...
        self.__mFilterSearchStockPanel.set_no_dividend_only(False)
    ...
    def __on_check_no_dividend_only(self, evt):   
        self.__mFilterSearchStockPanel.set_dividend_only(False)
    ...
    def __clear_checks(self, obj):
        print("HERE")
        arr = [self.__mcbMaxPriceMover, self.__mcbMinPriceMover, self.__mcbMinVolumeMover,
            self.__mcbMaxVolumeMover, self.__mcbTrailingPriceEarningsMax, self.__mcbForwardPriceEarningsMax,
            self.__mcbMoverAboveZero, self.__mcbMoverAboveFifty, self.__mcbMoverAboveHundred, 
            self.__mcbMoverBelowZero, self.__mcbMoverBelowFifty, self.__mcbMoverAboveZeroToTen,
            self.__mcbMoverAboveTenToTwenty, self.__mcbMoverAboveTwentyThirty, self.__mcbMoverAboveThirtyFourty,
            self.__mcbMoverBelowTenToTwenty, self.__mcbMoverBelowTwentyThirty, self.__mcbMoverBelowThirtyFourty,
            self.__mcbPriceToBookMax, self.__mcbBookValuePerShareMax, self.__mcbEPSTrailingTwelveMonthsMax, 
            self.__mcbEPSForwardMax, self.__mcbMoverFiftyWeeksAboveZero, self.__mcbMoverFiftyWeeksAboveFifty, 
            self.__mcbMoverFiftyWeeksAboveHundred, self.__mcbMoverFiftyWeeksBelowZero, self.__mcbMoverFiftyWeeksBelowFifty, 
            self.__mcbMoverFiftyWeeksAboveZeroToTen, self.__mcbMoverFiftyWeeksAboveTenToTwenty, self.__mcbMoverFiftyWeeksAboveTwentyThirty, 
            self.__mcbMoverFiftyWeeksAboveThirtyFourty, self.__mcbMoverFiftyWeeksBelowZeroToTen, self.__mcbMoverFiftyWeeksBelowTenToTwenty, 
            self.__mcbMoverFiftyWeeksBelowTwentyThirty, self.__mcbNoDividendOnly, self.__mcbDividendDateMin,
            self.__mcbDividendYeldMax]
        for a in arr:
            if a != obj:
                a.SetValue(False)
